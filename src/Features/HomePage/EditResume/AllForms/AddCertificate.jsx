...
import { Certificate } from "../../../../Json/resumeForm";
import { modifyCertificate } from "../../../../utils/ModifyData";
import { setCertificateData } from "../../../../app/features/resume/formSlice";
...
const AddCertificate = () => {
  ...
  useEffect(() => {
    dispatch(setCertificateData(modifyCertificate(formData)));
  }, [formData, dispatch]);
          ...
          onClick={(e) => {
            ...
            const newId =
              totalFields.length > 0
                ? Math.max(...totalFields.map((field) => field.id)) + 1
                : 1;
            setTotalFields((prevTotalFields) => [
              ...prevTotalFields,
